...
class NotificationManager extends EventEmitter {
  ...
  create(notify) {
    ...
    const newNotify = Object.keys(notify)
      .reduce((accumulator, key) => {
        return notify[key] ? ({...accumulator, [key]: notify[key]}) : ({...accumulator})
      }, {})
    if (notify.priority) {
      this.listNotify.unshift(Object.assign(defaultNotify, newNotify))
    } else {
      this.listNotify.push(Object.assign(defaultNotify, newNotify))
    }
    this.emitChange();
  }
